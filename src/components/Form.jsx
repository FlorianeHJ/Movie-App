...
const Form = () => {
    ...
    useEffect(() => {
        axios.get(`https://api.themoviedb.org/3/search/movie?api_key=09ba41025f3fca8724a8283ba52f321f&query=${search}&language=fr-FR`).then((res) => setMoviesData(res.data.results       
        ))
    }, [search])
